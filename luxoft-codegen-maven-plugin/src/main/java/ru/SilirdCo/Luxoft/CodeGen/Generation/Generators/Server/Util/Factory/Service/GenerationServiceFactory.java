package ru.SilirdCo.Luxoft.CodeGen.Generation.Generators.Server.Util.Factory.Service;
...
public class GenerationServiceFactory {
    ...
    private void generateMainPart(List<String> tableNames) {
        mainPart.append("public class ServiceFactoryGenerated {\n" +
                "    private ApplicationContext context = new ClassPathXmlApplicationContext(\"Factories/Services/Dictonaries/Generated/ServiceFactory.xml\");\n" +
                "\n" +
