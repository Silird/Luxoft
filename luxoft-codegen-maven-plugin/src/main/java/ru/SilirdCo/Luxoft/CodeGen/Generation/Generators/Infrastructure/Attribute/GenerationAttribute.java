package ru.SilirdCo.Luxoft.CodeGen.Generation.Generators.Infrastructure.Attribute;
...
public class GenerationAttribute {
    ...
    private void generateOneAttribute(GenerationMapping mapping) {
        oneAttribute.append("    public static ElementAttribute getAttribute(int type, int field, String value)  {\n" +
                ...
                "            case ID: {\n" +
                "                try {\n" +
                "                    Long castValue = Long.parseLong(value);\n" +
            ...
            for (GenerationColumn column : mapping.getColumns()) {
                ...
                switch (type) {
                    ...
                    case ("Date"): {
                        ...
                        oneAttribute.append("            case " + upperCase + ": {\n" +
                                "                try {\n" +
                                "                    Date castValue = StructureInfrastructure.formatTimeMillisecondTZ.parse(value);\n" +
    ...
    private void generateGetAttribute(GenerationMapping mapping) {
        twoAttribute.append("" +
                ...
                "            case ID: {\n" +
                "                try {\n" +
                "                    Long castValue1 = Long.parseLong(value1);\n" +
                "                    Long castValue2 = Long.parseLong(value2);\n" +
            ...
            for (GenerationColumn column : mapping.getColumns()) {
                ...
                switch (type) {
                    ...
                    case ("Date"): {
                        ...
                        twoAttribute.append("            case " + upperCase + ": {\n" +
                                "                try {\n" +
                                "                    Date castValue1 = StructureInfrastructure.formatTimeMillisecondTZ.parse(value1);\n" +
                                "                    Date castValue2 = StructureInfrastructure.formatTimeMillisecondTZ.parse(value2);\n" +
    ...
    private void generateGetAttributeList(GenerationMapping mapping) {
        listAttribute.append("    public static ElementAttribute getAttribute(int type, int field, List<String> values) {\n" +
                ...
                "            case ID: {\n" +
                "                try {\n" +
                "                    List<Long> listAttribute = new ArrayList<>();\n" +
